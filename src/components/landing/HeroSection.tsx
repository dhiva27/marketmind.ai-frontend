...
export function HeroSection({ onOpenDemoModal }: HeroSectionProps) {
  return (
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 bg-[#F8FAFC] text-slate-900 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-slate-950 hover:bg-slate-800 text-white font-bold text-xs sm:text-sm shadow-md transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full border border-slate-200 bg-white text-slate-800 font-semibold text-xs sm:text-sm hover:bg-slate-50 transition-all shadow-2xs"
              >
            ...
            {/* Trust Metrics */}
            <div className="pt-4 flex flex-wrap items-center gap-4 text-[11px] font-medium text-slate-500">
          ...
          {/* Right AI Dashboard Mockup (Exact match to reference screenshot) */}
          <motion.div
          ...
          >
            <div className="rounded-3xl p-1.5 bg-slate-200/50 shadow-xl border border-slate-200/80">
              <div className="rounded-2xl overflow-hidden bg-white border border-slate-100 shadow-xs flex flex-col md:flex-row min-h-[440px]">
                {/* Dark Left Sidebar */}
                <div className="w-full md:w-48 bg-[#0F0F12] text-slate-300 p-3.5 flex flex-col justify-between border-r border-slate-800 shrink-0">
                  <div className="space-y-3.5">
                    ...
                    {/* New Chat Button */}
                    <button className="w-full py-1.5 px-3 rounded-lg bg-purple-600 hover:bg-purple-500 text-white font-medium text-[11px] flex items-center justify-center gap-1 shadow-xs transition-colors">
                  ...
                  <div className="pt-3 border-t border-slate-800 flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 flex items-center justify-center text-white text-[9px] font-bold">
                      A
                    </div>
                    <div className="truncate">
                      <div className="text-[11px] font-semibold text-white truncate">Aravind</div>
                ...
                {/* Right Content Area */}
                <div className="flex-1 p-4 bg-[#FAFBFD] flex flex-col justify-between space-y-3">
                  <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-2.5">
                    ...
                    <div className="md:col-span-7 bg-white p-2.5 rounded-xl border border-slate-100 shadow-2xs relative">
                      ...
                      <div className="h-24 w-full relative">
                        ...
                        <div className="absolute top-1 right-4 bg-slate-900 text-white text-[8px] px-1.5 py-0.5 rounded-full shadow-xs font-semibold">
                          Ad: ₹2.45L
                        </div>
                      </div>
                    ...
                    {/* Top Recommendations */}
                    <div className="md:col-span-5 bg-white p-2.5 rounded-xl border border-slate-100 shadow-2xs flex flex-col justify-between space-y-1.5">
                      ...
                      <div className="space-y-1 text-[9px]">
                        <div className="p-1 rounded-md bg-purple-50 border border-purple-100 flex items-start gap-1">
                          ...
                          <div>
                            <div className="font-semibold text-slate-900 text-[9px]">Improve SEO for 3 pages</div>
                        ...
                        <div className="p-1 rounded-md bg-blue-50 border border-blue-100 flex items-start gap-1">
                          ...
                          <div>
                            <div className="font-semibold text-slate-900 text-[9px]">Create Reel Campaign</div>
                        ...
                        <div className="p-1 rounded-md bg-emerald-50 border border-emerald-100 flex items-start gap-1">
                          ...
                          <div>
                            <div className="font-semibold text-slate-900 text-[9px]">Optimize Google Ads</div>
